    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8 relative overflow-hidden bg-gradient-to-br from-sky-50 via-white to-blue-50">
      ...
      <div className="relative z-10 w-full max-w-2xl">
        ...
        <div className="text-center mb-8 space-y-3">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-sky-600 shadow-lg shadow-blue-500/30 mb-4">
        ...
        <Card className="shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-4 pb-6 border-b border-gray-100">
            <div className="flex items-center justify-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-sky-600 flex items-center justify-center shadow-lg shadow-blue-500/30">
            ...
            {/* Organization Badge */}
            <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-sky-50 rounded-xl border-2 border-sky-100">
          ...
          <CardContent className="pt-6 space-y-5">
            {/* Corporate Benefits */}
            <div className="grid grid-cols-3 gap-3 p-4 bg-gradient-to-r from-blue-50 to-sky-50 rounded-lg border border-sky-100">
            ...
            <Form {...form}>
              ...
              >
                ...
                <div className="pt-2 space-y-4">
                  <Button
                    type="submit"
                    className="w-full h-12 text-sm font-semibold bg-gradient-to-r from-blue-600 to-sky-600 hover:from-blue-700 hover:to-sky-700 text-white shadow-lg shadow-blue-500/30 transition-all duration-200 transform hover:scale-[1.02]"
                    disabled={isPending}
                  >
                    {isPending ? (
                      <>
                  ...
                  <div className="text-center text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
                    <Shield className="h-4 w-4 inline mr-1.5 text-sky-600" />
